...
`skills/github-code-review/skills/github-code-review/references/review-guide.md`.
_Avoid_: main agent as author of review body

**structure gate**:
Deterministic markdown structure checks. Single source of truth:
`skills/github-code-review/skills/github-code-review/scripts/validate_review_structure.py`.
