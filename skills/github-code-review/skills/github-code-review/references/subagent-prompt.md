...
```text
Execute a GitHub PR Code Review. You have read-only file access.
...
{SKILL_PATH}/references/review-guide.md

Follow Context Gathering, then Review Drafting, in order.

Return the complete review markdown and nothing else.
```
